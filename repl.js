...
require.define("/repl.coffee", function (require, module, exports, __dirname, __filename) {
    (function() {
  var Environment, Repl, env, evaluate, reader;
  ...
  Repl = (function() {
    ...
    Repl.prototype.evaluate = function(str) {
      var tree;
      tree = reader.readOne(str);
      return evaluate(tree, this.env);
    };
